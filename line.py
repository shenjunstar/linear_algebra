...
class Line(object):
    ...
    def intersection_with(self,ell):
        try:
            ...
            return Vector([x_numerator,y_numerator]).times_scalars(one_over_denom)
...
l_1 = Line(normal_vector=Vector([1.2,3.0]),constant_term=Decimal('0.8'))
l_2 = Line(normal_vector=Vector([2.4,6.0]),constant_term=Decimal('1.6'))
print(l_1==l_2)